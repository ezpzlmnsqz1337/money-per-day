...
class Store {
  ...
  removeFixedExpense(id) {
    db.collection('fixedExpenses')
      .doc(id)
      .delete()
      .then(() => console.log('Fixed expense deleted'))
  ...
  removeSpending(id) {
    db.collection('spendings')
      .doc(id)
      .delete()
      .then(() => console.log('Spending deleted'))
  ...
  removeExtraIncome(id) {
    db.collection('extraIncomes')
      .doc(id)
      .delete()
      .then(() => console.log('Extra income deleted'))
